; These  macrodefinitions are copied form linux sources
...
fname: db 'test.txt', 0 ; null terminating string

section .text
global _start

; These fonctions are used to print a null terminated string
print_string:
  push rdi
  call string_length
  pop rsi
...
_start:
  ;call open
  mov rax, 2 		; open file descriptor system call number
  mov rdi, fname
